...
const AddConsumer = () => {
  ...
  const Registerdealer = async (e) => {
    ...
    try {
      const url = `${BASE_url}/api/dealer/consumers`;
      const headers = {
      ...
      if (response.data.message === "Consumer registered successfully") {
        // Show success message using SweetAlert
        Swal.fire({
          title: "Good job!",
          text: "Consumer Registered Successfully.",
          icon: "success",
        });

        navigate("/viewdealerconsumer");
      }
    } catch (error) {
      ...
      <div className="row dashboardBoxWrapperRow">
        <div className="col-md-12">
          <div className="section-heading mb-4 p-4">
            <h4 className="font-weight-bold text-primary">Add Consumer</h4>
          </div>
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="form-group">
                    <label htmlFor="dealerName">Consumer Name</label>
                    <input
                      type="text"
                      id="dealerName"
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    <label htmlFor="dealerEmail">Consumer Email</label>
                    <input
                      type="email"
                      id="dealerEmail"
                      className="form-control"
