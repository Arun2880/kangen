 ...
 // const BASE_url = "http://localhost:5000";
  ...
  const Getproducts = async () => {
    try {
      ...
      console.log("response of Product list api", response);
  ...
  const Getcarts = async () => {
    try {
     ...
     setcountcart(response.data.data.items.length);
      console.log("cart count in get cart api", countcart);
    } catch (error) {
  ...
  // const cartCount = getcarts.length;
      ...
      <div className="container py-2">
        <Row className="align-items-center">
          ...
          >
            ...
            <Button
              className="mx-2 btn btn-success position-relative"
