...
const Consumer_orders = () => {
  ...
  const Getdealerlist = async () => {
    ...
    try {
      ...
      console.log("consumer list api", response);
  ...
  const handleViewOrders = async () => {
    ...
    try {
      const url = `${BASE_url}/api/admin/consumerorders/${selectedDealer}`;
      const headers = {
        "Content-Type": "application/json",
        Accept: "application/json",
        Authorization: `Bearer ${token}`,
      ...
      <div className="row dashboardBoxWrapperRow">
        <div className="col-md-12">
          <div className="section-heading mb-4 p-4">
            <h4 className="font-weight-bold text-primary">Consumers Orders</h4>
          </div>
          ...
          <div className="form-container bg-white p-4 shadow-sm">
            <div className="row d-flex justify-content-around">
              ...
              <div className="col-md-3">
                <div className="form-group">
                  <button
                    className="mt-5 px-4 py-2 btn btn-primary"
          ...
          <div className="form-container bg-white p-4 shadow-sm ">
            ...
            <div className="row">
              <div className="col-md-12">
                ...
                {orders.length === 0 && !loadingOrders && selectedDealer && (
...
export default Consumer_orders;
